        ...
        <div className="full-screen bears h-full w-full flex-col justify-between">
          <div className="h-screen-50vh flex w-[100%] flex-col self-start py-16 pr-10 lg:w-[75%] 2xl:w-[50%]">
            ...
            <p>
              ...
              towards animal suffering. We know suffering feels bad to us. But
              we also know that suffering feels bad for a dog or a cat. And we
              also know that suffering feels bad for a pig, a chicken or a fish.
            ...
            <p>
              ...
              mission to make life better for wild animals. There is much to
              learn about the situation of wild animals. This page is just an
