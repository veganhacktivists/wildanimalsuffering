  ...
  if (open) {
    return (
      ...
      >
        ...
        <div className="border-t border-bg-menu-back-light mt-16 md:mt-4 flex flex-col md:flex-row py-16 md:p-4 md:justify-between md:items-center">
          <div className="bg-logo invert bg-contain bg-no-repeat bg-center h-48 md:h-16 mb-14 md:mb-0 aspect-square"></div>
          <div className="text-8xl md:text-3xl text-menu-back-dark text-center flex justify-evenly">
            <b>FB</b>&nbsp;
            <b>YT</b>&nbsp;
            <b>P</b>&nbsp;
            <b>GH</b>
