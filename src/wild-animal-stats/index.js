...
const WildAnimalStats = () => {
	...
	return (
		<>
			<section id="abyss-container" className={`${abyssOverlay ? 'abyss-darkened' : 'abyss'} scrollsnap-y flex-col hw-screen`}>
					...
					<div className="h-screen-30vh md:h-screen md:w-screen-50vw flex-center split-screen-padding flex">
						...
						<div className="flex-center flex-col justify-around h-full text-left flex-grow">
							<div className="domestic-stats-container">
								<h1 className="">{lang['for-every-human']}</h1>
							...
							<div className="wild-stats-container hidden flex md:justify-between md:flex-col md:w-full md:h-5/6">
								...
								{!showHumans ? <div className="non-human-animals hidden">
									<h4 className="animal-stat blue">{lang['animal-stats-birds']}</h4>
									<h4 className="animal-stat hidden blue">{lang['animal-stats-wild-mammals']}</h4>
									<h4 className="animal-stat hidden green">{lang['animal-stats-reptiles']}</h4>
									<h4 className="animal-stat hidden green">{lang['animal-stats-amphibians']}</h4>
									<h4 className="animal-stat hidden orange">{lang['animal-stats-fish']}</h4>
									<h4 className="animal-stat hidden pink">{lang['animal-stats-earthworms']}</h4>
									<h4 className="animal-stat hidden purple">{lang['animal-stats-terrestrial-thropods']}</h4>
								</div> : null}
								<div>
