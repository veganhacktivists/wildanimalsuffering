const en = {
  ...
  "tend-to-have-a-lot-of-children":
    "Wild animals tend to have a lot of children, and for populations to remain stable, on average each parent can only have 2 children that reach adulthood. This means that most animals die young.",
  ...
  "credits-02":
    "Velit rhoncus pellentesque feugiat aenean tincidunt. Diam tincidunt aliquet mauris lorem.",
  "credits-03":
    "Egestas scelerisque ac risus. Neque nibh tellus elementum vulputate auctor",
