...
const Organisations = () => {
	...
	return (
		<>
			<section
				id="organisations-screen"
				data-name="Organisations"
				className="organisations screen-content"
			>
						...
						{organisations.map((organisation, index) => {
							return (
								<div
									...
									key={`${organisation.languageKey}-${index}`}
								>
									<div className="w-1/2 flex flex-row h-full">
										<div className="flex flex-row p-2">
											<div
												className={`${organisation.iconKey} aspect-square h-20`}
											></div>
										</div>
										<hr className="orange" />
										<div className="flex flex-col">
											<h4 className="p-2">
												{lang[`${organisation.languageKey}`]}
											</h4>
											<div className="text-justify p-2">
												{lang[`${organisation.languageKey}-description`]}
											</div>
