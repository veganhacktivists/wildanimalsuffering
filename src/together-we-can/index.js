...
const TogetherWeCan = () => {
	...
	const credits = ['credits-01', 'credits-02', 'credits-03', 'credits-04', 'credits-05', 'credits-06', 'credits-07', 'credits-08'];
			...
			<section id="together-we-can-screen" className="together-we-can screen-content">
				<div className="full-screen flex-col w-full h-full bears justify-between">
					...
					<div className="flex flex-row">
						...
						<div>
							{credits.map((creditKey) => <p key={creditKey}>{lang[creditKey]}</p>)}
						</div>
					</div>
				</div>
			</section>
