        ...
        <div className="grid p-4">
          <div className="col-start-1 row-start-1 grid place-items-center">
            <img
              ...
              src="/images/scale-of-suffering/chart-wild-animals.png"
              alt=""
            />
            <motion.img
              style={{ opacity: reptilesOpacity }}
              className="col-start-1 row-start-1"
              src="/images/scale-of-suffering/chart-reptiles.png"
              alt=""
            />
            <motion.img
              style={{ opacity: fishOpacity }}
              className="col-start-1 row-start-1"
              src="/images/scale-of-suffering/chart-fish.png"
              alt=""
            />
            <motion.img
              style={{ opacity: earthWormsOpacity }}
              className="col-start-1 row-start-1"
              src="/images/scale-of-suffering/chart-earth-worms.png"
              alt=""
            />
            <motion.img
