...
export function PopulationDynamics() {
  ...
  return (
    <section
      ...
      ref={scrollRef}
      className="relative min-h-screen bg-dirt-road bg-cover bg-center py-24"
    >
      <img
      ...
      <div className="relative mx-auto flex w-full max-w-7xl flex-col px-10">
        <div className="grid grid-cols-4">
          <div className="col-span-2 col-start-2 space-y-10">
            <h2 className="text-center font-brand text-4xl text-white">
              Population Dynamics
            </h2>
            <p className="mx-auto max-w-lg text-center text-lg text-white">
