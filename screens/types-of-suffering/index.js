    ...
    >
      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col space-y-10 px-10">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          <DialogItem
            imageUrl={thirstAndStarvationImage}
          ...
          />
          <DialogItem
            imageUrl={diseaseAndParasitismImage}
          ...
          />
          <DialogItem
            imageUrl={harmfulWeatherConditionsImage}
          ...
          />
          <DialogItem
            imageUrl={naturalDisastersImage}
          ...
          />
          <DialogItem
            imageUrl={anthropogenicHarmsImage}
